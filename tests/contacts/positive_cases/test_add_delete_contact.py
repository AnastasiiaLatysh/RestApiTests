...
class TestAddDeleteContacts(TestBaseContacts):
    ...
    def test_add_contact(self, contact_data):
        ...
        assert check_values_in_response_body(post_response.content, contact_data.values()), \
    ...
    def test_delete_contact(self, contact_data):
        ...
        delete_response = self.contacts_api.delete_contact(user_id=id_of_user_to_be_deleted)
        ...
        assert check_values_in_response_body(delete_response.content, contact_data.values()), \
            'Content is incorrect'
